        ...
        <div className="p-6">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              min="0"
              max={totalPages}
              className="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-all text-center text-lg"
            />
